...
public class DatosdePrueba
{
    ...
    {
        Cliente c1 = new Cliente(1, "Eriko Daniel Cruz", "0507-1976-00120");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(2, "Ismael Antonio Hernandez", "0507-1989-00356");
        ListadeClientes.Add(c2);

        Cliente c3 = new Cliente(3, "Ana Josefa Hernandez", "0507-1990-00439");
        ListadeClientes.Add(c3);
    }

    private void cargarVendedores()
    {
        Vendedor v1 = new Vendedor(1, "Fernando Cruz", "V0001");
        ListadeVendedores.Add(v1);

        Vendedor v2 = new Vendedor(2, "Irma Quiroz", "V0002");
